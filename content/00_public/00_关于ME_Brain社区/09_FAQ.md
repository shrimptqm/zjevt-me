...
- ❗如未安装 Obsidian，请参照 [[03_软件安装与配置教程#^d3f2b2|Obsidian安装与配置教程]] 进行安装。
...
类似知识图谱的schema，便于管理知识。

### 如何保证知识库里数据来源的准确性与可追溯性？

- 一手资料：原始数据，真实、准确、可追溯。记录应符合三现原则。
- 二手资料：对原始数据的解读。需与一手资料关联。
- 三手资料：结构化的一手资料与二手资料库。需与一手资料以及二手资料关联。

### 钉钉文档、PMS、Obsidian、Logseq、OA系统等，不同应用之间如何分工？数据如何交互？

不同的应用有不同的长处，比如钉钉文档的优势是与及时聊天工具结合，方便信息交互；而obsidian与logseq的优势是基于双向链接，构建符合认知神经学的知识网络。不同的应用好比不同的器官，我们要做的是各取所长，将这些器官造成一个有机的系统，让知识在流动中产生价值。

## Obsidian与Logseq的主要差异有哪些？
