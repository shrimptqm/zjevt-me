    ...
    if (text) {
      ...
      return (
        <p class={classNames(displayClass, "content-meta")}>
          ...
          🌟 <a href={`https://github.com/shrimptqm/zjevt-me/blame/v4/${fileRelativePath}`} class={classNames(displayClass, "external")} target={"_blank"} style={"font-weight:400"}>
          ...
          🗓️ <a href={`https://github.com/shrimptqm/zjevt-me/commits/v4/${fileRelativePath}`} class={classNames(displayClass, "external")} target={"_blank"} style={"font-weight:400"}>
